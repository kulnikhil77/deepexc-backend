...
def paid_redirect():
    """Razorpay redirects here after payment — we issue a token and redirect to HF."""
    # Token is generated by webhook; redirect with a placeholder
    # User will see the payment gate resolved via token in URL
